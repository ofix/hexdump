...
PaddingTextCtrl::PaddingTextCtrl(wxWindow* parent,
                                 wxWindowID id,
                                 const wxPoint& pos,
                                 const wxSize& size,
                                 long style,
    ...
    m_pTextCtrl = new wxTextCtrl(this, wxID_ANY, wxT(""), wxDefaultPosition, wxSize(240, 140),
                                 wxTE_MULTILINE | wxHSCROLL | wxNO_BORDER);
